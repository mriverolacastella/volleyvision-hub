...
def pdf_bytes(data, modules=None):
    ...
    story.append(Paragraph("VolleyVision Hub V2 · estable · creado por Marc Riverola Castellà", styles["Title"])); story.append(Spacer(1,12))
...
def main():
    ...
    st.markdown('<footer>VolleyVision Hub V2 · estable · creado por Marc Riverola Castellà</footer>', unsafe_allow_html=True)
